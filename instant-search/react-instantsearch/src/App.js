...
const App = props =>
  ...
  >
      ...
      <footer>
          Source Code on
          <a href="https://github.com/algolia/instantsearch.js/tree/v2/docgen/src/examples/demo">Github</a> -
  ...
  render() {
    ...
    return (
      <div className="ais-Slider__root">
        <Slider
          max={Math.trunc(max)} min={Math.trunc(min)}
...
function Hit({hit}) {
  return (<div className="hit">
    ...
    <div className="hit-content">
      ...
      <div className="hit-name"><Highlight attributeName="name" hit={hit}/></div>
      <div className="hit-description"><Highlight attributeName="description" hit={hit}/></div>
    </div>
  </div>);
}
